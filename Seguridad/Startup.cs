...
namespace Seguridad
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes("rRt36qOCpO942yOtvObKlaXjLfHDclG6"));
            services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme).AddJwtBearer(opt =>
           {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Seguridad", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Seguridad v1"));
            }
