...
namespace Extensiones.Services
{
    public class MailService : IMailService
    {
        ...
        public async Task SendEmailAsync(MailRequest mailRequest)
        {
            ...
            email.From.Add(new MailboxAddress(_mailSettings.NameFrom, _mailSettings.EmailFromAddress));
            ...
            smtp.Authenticate(_mailSettings.MailAuthUser, _mailSettings.MailAuthPass);
